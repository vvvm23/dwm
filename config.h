...
static const char *fonts[]          = { "Monaco:style=Regular:pixelsize=14:antialias=true:autohint=true" };
static const char dmenufont[]       = "Monaco:style=Regular:pixelsize=16:antialias=true:autohint=true";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,                       XK_b,      togglestatus,      {0} },
