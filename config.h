...
static const char *fonts[]          = { "Meslo LG L:pixelsize=14:antialias=true:autohint=true" };
static const char dmenufont[]       = "Meslo LG L:pixelsize=14:antialias=true:autohint=true";
